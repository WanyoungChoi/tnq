...
const POLICY_ITEMS = [
  {
    image: `${ESG_IMG}/esg2_1.JPG`,
    fileName: "인권정책_TNQ_2026 0601.docx",
    altKey: "policyImageAlt1",
  },
  {
    image: `${ESG_IMG}/esg2_2.JPG`,
    fileName: "윤리강령_TNQ_2026 0601.docx",
    altKey: "policyImageAlt2",
  },
  {
    image: `${ESG_IMG}/esg2_3.JPG`,
    fileName: "안전보건정책_TNQ_2026 0601.docx",
    altKey: "policyImageAlt3",
  },
  {
    image: `${ESG_IMG}/esg2_4.JPG`,
    fileName: "협력사행동규범_TNQ_2026 0601.docx",
    altKey: "policyImageAlt4",
  },
];

export async function generateMetadata() {
  const t = await getTranslations("metadata");
  return { title: t("esgSocialTitle"), description: t("esgSocialDesc") };
}

export default async function TNQ21EsgSocialPage() {
  const t = await getTranslations("esgSocial");
