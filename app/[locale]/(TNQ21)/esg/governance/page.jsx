...
const POLICY_ITEMS = [
  {
    image: `${ESG_IMG}/esg3_1.JPG`,
    fileName: "이사회 운영규정_TNQ_2026 0130.hwp",
...
export async function generateMetadata() {
  ...
  return { title: t("esgGovernanceTitle"), description: t("esgGovernanceDesc") };
}

export default async function TNQ21EsgGovernancePage() {
  const t = await getTranslations("esgGovernance");
