...
const divSections = [
  {
    ...
    bgImage: "/assets/images/tnq21/main/1.png",
    darkclassName: "home-section bg-scroll bg-dark-alpha-70",
  },
  {
    className: "home-section bg-scroll",
    bgImage: "/assets/images/tnq21/main/2.png",
    darkclassName: "home-section bg-scroll bg-dark-alpha-70",
  },
  {
    className: "home-section bg-scroll bg-light-alpha-50",
    bgImage: "/assets/images/tnq21/main/3.png",
    darkclassName: "home-section bg-scroll bg-dark-alpha-70",
  },
];
export default function Hero5Main2({ dark }) {
